...
insert into complaints (complaint) values ('SKUPPER - Just a first initial complaint');
insert into complaints (complaint) values ('SKUPPER - And another one initially loaded');
